...
/**
 * Jersey REST client generated for REST resource:CategorieFacadeREST
 * [database.categorie]<br>
 *  USAGE:
 * <pre>
 ...
 * @author zakaria
 */
public class CategorieRestfulClient {
    private WebResource webResource;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/AchatGroupeRestful/webresources";

    public CategorieRestfulClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("database.categorie");
    }
