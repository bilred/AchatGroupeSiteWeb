...
/**
 * Jersey REST client generated for REST resource:AchatgroupeFacadeREST
 * [database.achatgroupe]<br>
 *  USAGE:
 * <pre>
 *        AchatGroupeRestfulClient client = new AchatGroupeRestfulClient();
 ...
 * @author zakaria
 */
public class AchatGroupeRestfulClient {
    private WebResource webResource;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/AchatGroupeRestful/webresources";

    public AchatGroupeRestfulClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("database.achatgroupe");
    }
